<nav className="bg-[#121e31] h-screen fixed top-0 left-0 min-w-[250px] py-6 px-4 tracking-wide overflow-auto">
      ...
      <ul className="space-y-3">
        <li>
          <a href="javascript:void(0)" className="text-white text-[15px] font-normal flex items-center hover:bg-gray-700 rounded px-4 py-2 transition-all">
        ...
        <li>
          <a href="javascript:void(0)" className="text-white text-[15px] font-normal flex items-center hover:bg-gray-700 rounded px-4 py-2 transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-[18px] h-[18px] mr-3" viewBox="0 0 16 16">
              <path
        ...
        <li>
          <a href="javascript:void(0)" className="text-white text-[15px] font-normal flex items-center hover:bg-gray-700 rounded px-4 py-2 transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" stroke='currentColor' className="w-[18px] h-[18px] mr-3"
